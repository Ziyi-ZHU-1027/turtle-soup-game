      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <h3>神秘谜题</h3>
            <p>精心设计的海龟汤谜题，涵盖经典、恐怖、逻辑等多种类型</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🤖</div>
            <h3>AI主持人</h3>
            <p>DeepSeek AI智能主持人，根据汤底准确回答是/否/无关问题</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">💡</div>
            <h3>智能提示</h3>
            <p>根据对话进度提供智能提示，帮助玩家推理</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">📊</div>
            <h3>数据统计</h3>
            <p>记录游戏数据，分析推理能力，查看历史对话</p>
          </div>
        </div>
      </div>
    </div>
